        ...
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          <form class="space-y-4 md:space-y-6" action="#">
            ...
            <button
              @click="login"
              type="button"
              class="relative w-full text-white bg-[#1C64F2] hover:bg-[#76A9FA] focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
            >
              Sign in
              <svg
                v-show="loading"
                aria-hidden="true"
                role="status"
                class="inline w-4 h-4 mr-3 text-white animate-spin ml-1"
                viewBox="0 0 100 101"
                fill="none"
